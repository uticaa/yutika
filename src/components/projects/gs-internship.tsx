...
function GsInternship() {
    const projectDetails = {
        ...
        overview: <span>As part of my internship, I led the effort to document the first pattern in the design system - the Form Pattern. <br/> <br/> This project aimed to bring clarity, consistency, and scalability to form design across the firm. By combining internal insights with industry research and close collaboration with the design system team, I created a comprehensive resource that could be leveraged by designers, developers, and product managers.</span>,
        note: {
            title: "Note",
            content: 
            <>
